        ...
        children: [ Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text("Sign Up", style: TextStyle(color: AppColors.primaryColor, fontSize: 25, fontWeight: FontWeight.bold),),
                ...
                TextField(
                  obscureText: _isObScureText2,
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.key, color: AppColors.primaryColor,),
                      suffix: GestureDetector(
                        onTap: (){
                          setState(() {
                        ...
                        child: Icon(_isObScureText2 ? Icons.visibility : Icons.visibility_off)
                        ),
                      filled: true,
                      fillColor: AppColors.lightBlue,
                      border: OutlineInputBorder(
